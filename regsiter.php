...
<?php                                                                                                               
    $cat_res4=mysqli_query($con,"select * from meta_data where page='register'");
    $cat_arr4=array();
    ...
    <div class="md:w-[80%] lg:w-[64%] w-full overflow-x-hidden mx-auto">
        ...
        <div
            ...
            <div class="gap-4">
                ...
                <p class="text-xs py-2 px-5 text-[#002D74]">If you are already a member, easily log in</p>
                <div class="py-2 px-5 border rounded-xl hover:scale-110 duration-300">
                      
                      <form action="" class="flex flex-col gap-4">
                        <input class="rounded-xl border" type="text" name="name" placeholder="Full Name" required>
                        <input class="rounded-xl border" type="email" name="email" placeholder="Email" required>
                        <input class="rounded-xl border" type="number" name="mobile" placeholder="Enter Mobile Number" required>
                        <div class="relative">
                        ...
                        <button class="py-2 px-5 border rounded-xl hover:scale-110 duration-300">Create Account</button>
                      </form>
                      <div class="mt-3 text-xs flex justify-between items-center text-[#002D74]">
                        <p>Have an account?</p>
                        <p><a href="signin" class="py-1 px-5 border rounded-xl hover:scale-110 duration-300">Sign In!</a></p>
                      </div
                </div>
            </div>
        </div>
